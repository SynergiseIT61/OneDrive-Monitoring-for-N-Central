...
.Synopsis
   Get OneDrive Status
.DESCRIPTION
   Get OneDrive Status using the new available API in Windows 11 and some new Windows 10 Versions
.EXAMPLE
   Get-ODStatusFromDLL
.EXAMPLE
   Get-ODStatusFromDLL -IgnoreQuota
...
do 
{
    ...
    [uint64]$Size = 0
    Write-Host "MaxSize: $MaxSize / Type: $($MaxSize.GetType())"
    $HRESULT = [ODSyncLib]::GetODSyncStatus($IgnoreQuota, $Result, $MaxSize, [ref]$Size)

    if ($HRESULT -eq 0) {
        return ConvertFrom-Json -InputObject $Result.ToString()
        ...
        $MaxSize = $Size + 1 # Add 1 to the string terminator
    }
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUQYDoZoLTCKO8sokJOzBpsFgS
# vqiggiK8MIIEMjCCAxqgAwIBAgIBATANBgkqhkiG9w0BAQUFADB7MQswCQYDVQQG
...
# FLnGcUke+J0E2kA5Mltoau6f0ZtuMA0GCSqGSIb3DQEBAQUABIIBABssqf9Rcelh
# rVuG9xkHrRv9ZJGUIL/Sa08amI+eR/a8CKV01YZuqctX8q0tQfPuFJd3IrgR/Bmk
# jEmXATFl3pwJrzrF2ObsQgFzItBJFTv2tPRrIbbjn5YyCKDhIvZ+gvw76wyosUHA
# IT6wGka3PnHW7dgd3SW6byuqUqp6rfdT+8OwN6eOexOC6GhCMIzUKCxlqoS3Q4eb
# UGapaaalU0852iaF1yXTeS6vngFFUToW9bVoa3Y6xvg8VPek0wpzZmXa2cdDxMT6
# CedpWIsVs8pRqqEvblAqf6UpuG3QT6+Ie9W8ynbBKMnu+A/0ybPxKOqJ4jr2LIcu
# Vw4bO5bcruahggNLMIIDRwYJKoZIhvcNAQkGMYIDODCCAzQCAQEwgZEwfTELMAkG
# A1UEBhMCR0IxGzAZBgNVBAgTEkdyZWF0ZXIgTWFuY2hlc3RlcjEQMA4GA1UEBxMH
...
# CQUxDxcNMjQwMzIxMTcyMDUyWjA/BgkqhkiG9w0BCQQxMgQwSN7jbbDgZ2wlw6gT
# 3jAyThv9uPQ4kLSmd0/CPUOjRqTm2uKBDOWP6rqMpDG3pJ2zMA0GCSqGSIb3DQEB
# AQUABIICAErZFrpwr1Uxhb6RVvtVmr3idqectqUFwOZanlTzX3oQZwP6pLwysVAa
# BvqhXDIsFh0fztiYOYTc1zWXv9g3Za7qfkJ1lOpyVxsGNctK/aM64/pWfeoq+c1n
# r2wMSUjsPuP0fDakpeU5FE7lb+o/8dgRT2mWHPihuTn7Kn5gj4qbaHul8cl5dxWT
# u2BoujGSYZUHgiZH1JCOiTvEgDiubswGfxm9Mr+RWKQfS9bGMdT+1DJnc7Lkh7r+
# JwdGpTZSvtiUxBaM+KGWVt1DgEGLsWvdZ0rACUnWrl8RS093ThatwhQhQavKGmIx
# 242oqqqKxBxMYBPUApaL351ehEUeOot5gOr+Ls6Ib49NhDWsdzw0DCcuCBiKDx9r
# Q+9vUQ1UV4cdqOhKXm2w1IF5HDNeQSNnUYZu5kQMoMa1/veF8Crn01r1jQSj+rYn
# 3lw1c88wJreqkk5073g71PFoFxNyEPj66f6eFBYOlFvDK7bG6YiR8zDxPF8Zix1a
# MtAIKTLswrJJS2fSkSK5x/6Qa19DnhYUS+aXuNX1rnxkU0s+RntpTDNEeNp/xYGB
# ydZSgSmB6XBT+ApYs6UG27z7cCL1Y/dXKfLhm9wFm6naJrNEDn7Ag856uub1+uJM
# UiqFpM/dpnbzqxP5awg3wO0UtlnW9VBgAjl5OqeDj/yU46xQav4N
